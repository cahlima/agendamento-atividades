        ...
        <div class="col-md-8">
            <div class="card">
                ...
                <ol class="breadcrumb card-header ">
                    <li class="breadcrumb-item "><a href="{{ route('matricula') }}"> Matricula</a></li>
                    <li class="breadcrumb-item active">Adicionar</li>
                </ol>

                <div class="card-body">
                    <form action="{{route('matricula.salvar')}}" method="post">
                        {{csrf_field()}}
                        <div class="form-row">
                            ...
                            <div class="form-group col-md-12 ">
                                <label for="atividades_id">ID AULA</label>
                                <input type="text" class="form-control" id="atividades_id" name="atividades_id" value="5">
                            </div>
                            <div class="form-group col-md-12 ">
