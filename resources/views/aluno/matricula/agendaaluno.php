...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">{{ __('Listagem Meus Matriculamentos') }}</div>
                    ...
                    <table class="table table-bordered">
                            ...
                            <tbody>
                                ...
                                <tr class="text-center">
                                    ...
                                    @can('viewbtnConfirmAgend',App\Models\Matricula::class)
                                    @if($matricula->status != 4 and $matricula->status != 2)
                                    <td>
                                    ...
                                    <td>
                                        ...
                                        <a href="{{route('matricula.editaraluno',$matricula->id_matricula)}}@extends('layouts.app')
...
@endsectioniv  class="alert {{Session::get('flash_message')['class']}} text-center">
                                {{Session::get('flash_message')['msg']}}
                                </div>
                            </div>
                        </div>
